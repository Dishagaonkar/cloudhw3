...
def lambda_handler(event, context):
    ...
    print("extracted_labels from Lex:", extracted_labels)

    # --- Fallback: if Lex gives nothing, use the raw query ---
    if not extracted_labels:
        extracted_labels = [user_query]
        print("No Lex slots, falling back to raw query:", extracted_labels)
    ...
    print("Final image_metadata:", image_metadata)
